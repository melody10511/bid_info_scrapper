...
public class OptionFrame extends JFrame {
	...
	public OptionFrame() {
		...
		iepath = new JTextArea(1, 10);
		iepath.setText(Resources.IE_DRIVER_PATH);
		iepath.setBorder(BorderFactory.createLineBorder(Color.black));
		...
		iePanel.add(new JLabel("IE Driver : "));
		iePanel.add(iepath);
	...
	private class ConfirmListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			Resources.setValues(dbid.getText(), new String(dbpw.getPassword()), schema.getText(), basePath.getText(), iepath.getText());
			closeFrame();
		}
	}
